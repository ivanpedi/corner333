const API_KEY = '7e8209b6c66e49609b062d823bab00ee'; // Tu API key
const proxyUrl = 'https://cors-anywhere.herokuapp.com/';  // Proxy temporal
const apiUrl = `https://newsapi.org/v2/everything?q=moda+deportiva&language=es&apiKey=${API_KEY}`;
const url = `${proxyUrl}${apiUrl}`;  // Combina el proxy con la URL de la API
